        ...
        <div className="flex flex-col gap-10 h-full bg-primary-lm p-10 rounded-2xl border-2 border-stroke-grey">
          ...
          {filteredPosts.length === 0 ? (
            ...
            filteredPosts.map((p) => (
              ...
              <div key={p.id} className="relative bg-secondary-lm p-8 rounded-xl border border-stroke-grey hover:bg-hover-lm transition border-2 border-stroke-grey hover:border-stroke-peach p-8 rounded-2xl">
