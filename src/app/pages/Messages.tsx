...
import {
  ...
  sendMessage,
  type ChatThread,
} from "@/features/messages/api/chatStore";
...
export default function Messages() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[240px_520px] gap-4 p-4 min-h-[70vh] md:max-w-[800px] md:ml-auto">
      {/* Sidebar */}
                ...
                activeThread.messages.map((m) => (
                  <div
                    ...
                    className={cn(
                      ...
                      m.from === "me"
                        ? "ml-auto bg-[var(--color-message-user-lm)] text-primary-lm"
                        : "mr-auto bg-[var(--color-message-other-lm)] text-text-lm"
                    )}
                  >
                    {m.text}
                  </div>
