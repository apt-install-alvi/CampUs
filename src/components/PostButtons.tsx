...
{
  return (
    <button onClick={clickEvent} className="flex gap-2 px-4 py-2 font-bold text-accent-lm bg-primary-lm hover:bg-background-lm transition border-2 border-stroke-peach rounded-full cursor-pointer">
      <img src={icon}></img>
      {label}
    </button>
  );
